package com.cafstone.dicodingstoryapp.view.customview
...
class CustomPasswordInputLayout(context: Context, attrs: AttributeSet) : AppCompatEditText(context, attrs) {
